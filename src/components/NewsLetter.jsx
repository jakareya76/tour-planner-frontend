          ...
          <div className="w-full md:w-1/2">
            <div className="my-4 collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  To create a tour plan on Tour Planner, simply sign up or log
                  in to your account. Once logged in, navigate to the "add
                  tourists spot" page where you can input details such as
                  destination, dates, activities, and any additional notes.
                  After filling out the necessary information, click on the "add
                  tourists spot" button to save your plan.
                </p>
              </div>
            </div>
            <div className="my-4 collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  Yes, you have full control over your tour plans. After
                  creating a tour plan, you can easily edit or delete it
                  according to your preferences. Simply locate the tour plan you
                  wish to modify in your account dashboard, then select the
                  "Edit" or "Delete" option. Make your desired changes and save
                  them to update your tour plan.
                </p>
              </div>
            </div>
            <div className="my-4 collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  Tour Planner allows you to discover tour plans created by
                  fellow travelers. To explore these plans, navigate to the
                  "Discover Tours" section on the website. Here, you'll find a
                  variety of tour plans sorted by destination, popularity, and
                  other filters. Click on any tour plan to view its details,
                  itinerary, and user reviews.
                </p>
              </div>
            </div>
            <div className="my-4 collapse collapse-plus bg-base-200">
